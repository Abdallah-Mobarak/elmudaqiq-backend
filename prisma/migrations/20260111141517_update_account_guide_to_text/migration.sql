...
-- AlterTable
ALTER TABLE `accountguide` MODIFY `level` TEXT NOT NULL,
    MODIFY `accountName` TEXT NOT NULL,
    MODIFY `rulesAndRegulations` TEXT NULL,
    MODIFY `disclosureNotes` TEXT NULL,
    MODIFY `code1` TEXT NULL,
    MODIFY `code2` TEXT NULL,
    MODIFY `code3` TEXT NULL,
    MODIFY `code4` TEXT NULL,
    MODIFY `code5` TEXT NULL,
    MODIFY `code6` TEXT NULL,
    MODIFY `code7` TEXT NULL,
    MODIFY `code8` TEXT NULL,
    MODIFY `objectiveCode` TEXT NULL,
    MODIFY `relatedObjectives` TEXT NULL;
