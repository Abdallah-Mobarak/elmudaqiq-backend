/*
  ...
  - You are about to drop the column `commerceWebsite` on the `branch` table. All the data in the column will be lost.
  - You are about to drop the column `cpaWebsite` on the `branch` table. All the data in the column will be lost.
  - You are about to drop the column `taxWebsite` on the `branch` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `branch` DROP COLUMN `commerceWebsite`,
    DROP COLUMN `cpaWebsite`,
    DROP COLUMN `taxWebsite`;
