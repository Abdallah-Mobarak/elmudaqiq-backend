...
-- AlterTable
ALTER TABLE `engagementcontract` ADD COLUMN `branchId` INTEGER NULL;
...
CREATE TABLE `ContractStaff` (
    ...
    UNIQUE INDEX `ContractStaff_contractId_userId_key`(`contractId`, `userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `ContractReviewGuide` (
    `id` VARCHAR(191) NOT NULL,
    `contractId` VARCHAR(191) NOT NULL,
    ...
    INDEX `ContractReviewGuide_contractId_idx`(`contractId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ContractDocument` (
    `id` VARCHAR(191) NOT NULL,
    `contractId` VARCHAR(191) NOT NULL,
    `reviewGuideId` VARCHAR(191) NULL,
...
-- CreateIndex
CREATE INDEX `EngagementContract_branchId_idx` ON `EngagementContract`(`branchId`);
